                ...
                Column(
                    ...
                    CustomCard {
                        Column(
                            ...
                            Text(
                                text = "Endereço: ${state.enderecoPontoPartida}",
                                fontSize = 14.sp,
                                color = Azul
                            )
                            Column(
                                ...
                                InputField(
                                    ...
                                    value = state.pontoPartida,
                                    startIcon = PontoPartida,
                                    buttonIconEnabled = false
                                ) {
                                    viewModel.onChangeEvent(ProcurarViagemField.PontoPartida(it))
                                }
                                InputField(
                                    label = stringResource(id = R.string.label_ponto_de_chegada),
                                    value = state.pontoChegada,
                                    startIcon = Localizacao,
                                    buttonIconEnabled = false
                                ) {
                                    viewModel.onChangeEvent(ProcurarViagemField.PontoChegada(it))
                                }
                                InputField(
